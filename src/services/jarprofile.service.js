...
// 6 lọ mặc định
const DEFAULT_JARS = [
    { name: "Nhu cầu thiết yếu", icon: "shopping_bag", color: "#F97316", percent: 55 },
    { name: "Giáo dục", icon: "school", color: "#3B82F6", percent: 10 },
    { name: "Giải trí", icon: "celebration", color: "#EC4899", percent: 10 },
    { name: "Tiết kiệm dài hạn", icon: "piggy_bank", color: "#10B981", percent: 10 },
    { name: "Tự do tài chính", icon: "trending_up", color: "#F59E0B", percent: 10 },
